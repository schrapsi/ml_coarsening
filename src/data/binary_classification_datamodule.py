...
class BinaryClassificationDataModule(LightningDataModule):
    def __init__(
            self,
            data_dir: str,
            ...
            scaler = None,
            threshold: float = 0.1,  # Threshold for binary classification
    ):
        super().__init__()
    ...
    def setup(self, stage=None):
        ...
        # Separate features and binary targets
        X_train = X.iloc[train_idx]
        y_train = binary_labels.iloc[train_idx]
        X_val = X.iloc[val_idx]
        y_val = binary_labels.iloc[val_idx]
        ...
        # Convert to tensors with appropriate types for binary classification
